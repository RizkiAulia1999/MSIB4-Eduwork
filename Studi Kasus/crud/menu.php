...
<body>
    <?php
        ...
        $query_menu = mysqli_query($conn, "SELECT menu.*, kategori.Kategori FROM menu inner join kategori 
                                           on menu.IDKategori = kategori.IDKategori ORDER BY menu.IDMenu ASC");
    ?>
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="col-md-9 offset-md-2 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="create_menu.php" class="btn btn-secondary mt-2" href="">Tambah</a><br><br>
                            ...
                            <?php
                               ...
                               $no++;
                                echo "
                                    <tr>
                                        <td>".$no."</td>
                                        <td><img src='images/".$menu['Gambar']."' width='150' height='150'></td>
                                        <td>".$menu['Nama_menu']."</td>
                                        <td>".$menu['Kategori']."</td>
                                        <td class='text-center'>".$menu['Stok']."</td>
                                        <td>".$menu['Harga']."</td>
                                        <td>
                                            <a href='edit_menu.php?IDMenu=".$menu['IDMenu']."' class='btn btn-danger'>Edit</a>     
                                            <a href='delete_menu.php?IDMenu=".$menu['IDMenu']."' class='btn btn-warning' >Delete</a>                     
                                        </td>  
                                    </tr>
                                 ";
                               } 

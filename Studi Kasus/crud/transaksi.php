...
<body>
    <?php
        include "connect.php";
        $query_transaksi = mysqli_query($conn, "SELECT * FROM transaksi inner join kategori 
                                                on transaksi.IDKategori = kategori.IDKategori inner join menu 
                                                on transaksi.IDMenu     = menu.IDMenu inner join user
                                                on transaksi.IDUser     = user.IDUser
                                                ORDER BY transaksi.IDTransaksi ASC");
    ?>
    <!-- Navbar -->
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="col-md-9 offset-md-2 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="create_transaksi.php" class="btn btn-secondary mt-2" href="../home.php">Tambah</a><br><br>
                            ...
                            <?php
                               ...
                               $no++;
                                echo "
                                    <tr>
                                        <td>".$no."</td>
                                        <td class='text-center'>".$transaksi['user']."</td>
                                        <td>".$transaksi['Nama_menu']."</td>
                                        <td>".$transaksi['Kategori']."</td>
                                        <td>".$transaksi['Jumlah_Pesan']."</td>
                                        <td>".$transaksi['Total_Harga']."</td>
                                        <td>
                                            <a href='edit_transaksi.php?IDTransaksi=".$transaksi['IDTransaksi']."' class='btn btn-danger'>Edit</a>     
                                            <a href='delete_transaksi.php?IDTransaksi=".$transaksi['IDTransaksi']."' class='btn btn-warning' >Delete</a>         
                                        </td>  
                                    </tr>
                                 ";
                               } 

...
<body>
    <?php
        include "connect.php";
        $query_kategori = mysqli_query($conn, "SELECT * FROM kategori ORDER BY IDKategori ASC");
    ?>
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="col-md-8 offset-md-2 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="create_kategori.php" class="btn btn-secondary mt-2" href="">Tambah</a><br><br>
                    <table class="table mt-2" id="myTable">
                        ...
                        <tbody>
                            ...
                            echo "
                                <tr>
                                    <td>".$no."</td>
                                    <td><img src='images/".$kategori['Gambar']."' width='150' height='150'></td>
                                    <td>".$kategori['Kategori']."</td>
                                    <td>
                                        <a href='edit_kategori.php?IDKategori=".$kategori['IDKategori']."' class='btn btn-danger'>Edit</a>     
                                        <a href='delete_kategori.php?IDKategori=".$kategori['IDKategori']."' class='btn btn-warning' >Delete</a>                     
                                    </td>  
                                </tr>
                                 ";
                               } 
